    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {isArabic ? "أفضل مبيعاتنا" : "OUR BEST SELLERS"}
          </Typography>
          <Box
            sx={{
              width: "auto",
